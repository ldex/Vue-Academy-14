    ...
    <form @submit.prevent="onSubmit" novalidate>
        ...
        <div class="form-group" :class="{ 'form-group--error': v$.$error && v$.product.name.$error }">
            ...
            <p v-if="v$.$error" class="errorMessage">
                ...
                <span v-if="v$.product.name.minLength.$invalid">Name must have at least {{ v$.product.name.minLength.$params.min }} characters!</span>
                <span v-if="v$.product.name.maxlength.$invalid">Name must have less than {{ v$.product.name.maxlength.$params.max }} characters!</span>
            </p>
        </div>
        ...
        <div class="form-group" :class="{ 'form-group--error': v$.$error && v$.product.description.$error }">
            ...
            />
            <p v-if="v$.$error" class="errorMessage">
                <span v-if="v$.product.description.minLength.$invalid">Description must have at least {{ v$.product.description.minLength.$params.min }} characters!</span>
                <span v-if="v$.product.description.maxlength.$invalid">Description must have less than {{ v$.product.description.maxlength.$params.max }} characters!</span>
            </p>
        </div>
        ...
        <div class="form-group" :class="{ 'form-group--error': v$.$error && v$.product.price.$error }">
            ...
            <p v-if="v$.$error" class="errorMessage">
                ...
                <span
                v-if="v$.product.price.between.$invalid">Price must be between {{ v$.product.price.between.$params.min }} and {{ v$.product.price.between.$params.max }}</span>
            </p>
        </div>
